...
const WHATSAPP_NUMBER = "8801732646399"; // Please replace with your real number
...
export default function ServiceLandingPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] pt-16 selection:bg-indigo-500 selection:text-white pb-10">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center sm:text-left">
          ...
          >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="inline-flex items-center gap-2 bg-transparent text-[#25D366] hover:bg-[#25D366]/10 px-8 py-3.5 rounded-xl font-semibold border border-[#25D366] hover:-translate-y-0.5 transition-all outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 dark:focus:ring-offset-gray-900"
            >
            ...
            {data.packages.map((pkg, i) => (
              <FadeIn key={pkg.name} delay={i * 0.15}>
                <div className={`relative bg-white dark:bg-[#111318] border rounded-2xl p-8 flex flex-col h-full transition-all hover:-translate-y-1 ${
                  ...
                  {pkg.tag && (
                    <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-[11px] font-bold uppercase tracking-wider px-4 py-1.5 rounded-full whitespace-nowrap z-10 shadow-md">
                      {pkg.tag}
                    </div>
                  )}
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-transparent text-[#25D366] hover:bg-[#25D366]/5 px-8 py-3.5 rounded-xl font-semibold border border-[#25D366] hover:-translate-y-0.5 transition-all"
                >
                  <MessageCircle className="w-5 h-5" />
                  WhatsApp me
                </a>
