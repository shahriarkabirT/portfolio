...
const AboutMe = () => {
  return (
    <section
      id="about"
      className="py-16 px-6 md:px-12 bg-[var(--background)] text-[var(--foreground)] dark:bg-gradient-to-b dark:from-[#0f0f0f] dark:to-[#1a1a1a]"
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-[var(--text-secondary)] dark:text-gray-400 max-w-2xl mx-auto">
            Full-stack developer and tech entrepreneur passionate about building
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="w-64 h-64 md:w-72 md:h-72 bg-white dark:bg-gray-800 rounded-full overflow-hidden border-4 border-indigo-500/20">
          ...
          >
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl font-semibold text-[var(--text-primary)] dark:text-white mb-2">
              ...
              <p className="text-[var(--text-secondary)] dark:text-gray-300">
                I'm a full-stack developer with expertise in MERN stack and a
                strong foundation in software development principles.
                Experienced in building responsive web applications,
                implementing authentication systems, and managing VPS hosting
                environments. Passionate about exploring AI technologies and
              ...
              <div className="bg-white dark:bg-[#1a1a1a] rounded-xl p-6 border border-gray-200 dark:border-gray-800">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <a href="https://ccloude.com">
                    <h4 className="text-xl font-semibold text-[var(--text-primary)] dark:text-white">
                      Collaborative Cloud
                    </h4>
                  </a>
                </div>
                <p className="text-[var(--text-secondary)] dark:text-gray-300 mb-4">
                  As founder of Collaborative Cloud, I'm building innovative
                  cloud solutions that empower teams to work more efficiently.
                  Our platform integrates cutting-edge technologies to
                  streamline collaboration and project management.
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-full text-sm text-gray-800 dark:text-white">
                    Cloud Computing
                  </span>
                  <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-full text-sm text-gray-800 dark:text-white">
                    Team Collaboration
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3 bg-white dark:bg-[#1a1a1a] rounded-lg p-4 border border-gray-200 dark:border-gray-800">
                  <Briefcase className="w-5 h-5 text-indigo-400 mt-1" />
                  <div>
                    <h4 className="font-semibold text-[var(--text-primary)] dark:text-white">
                      Experience
                    </h4>
                    <p className="text-[var(--text-secondary)] dark:text-gray-400 text-sm">
